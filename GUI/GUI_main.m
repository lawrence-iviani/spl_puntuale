...
% Last Modified by GUIDE v2.5 07-Apr-2009 13:41:02
...
% hObject    handle to AddSpeaker (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% Chiamo l'interfaccia per aggiungere uno speaker
GUI_addSpeaker('GUI_AddSpeaker', handles.FigureMain);

% --- Executes on button press in GoPrediction.
function GoPrediction_Callback(hObject, eventdata, handles)
% hObject    handle to GoPrediction (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', 1, ...
    'blocking', 0, ...
    'lastSavedFile', '/Users/davidelinzi/Documents/MATLAB/spl_puntuale/GUI_main.m', ...
    'lastFilename', '/Users/davidelinzi/Documents/MATLAB/spl_puntuale/GUI_main.fig');
appdata.lastValidTag = 'FigureMain';
...
'Parent',h1,...
'Units','characters',...
'Title','SPL Puntuale & PUPPA',...
'Tag','uipanel1',...
'Clipping','on',...
'BackgroundColor',get(0,'defaultuipanelBackgroundColor'),...
'Position',[5.5 1.25 102.833333333333 29.5833333333333],...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );

appdata = [];
appdata.lastValidTag = 'AddSpeaker';
...
'Callback',mat{1},...
'Position',[7.5 25 11 1.75],...
'String','Add a Speaker',...
'Tag','AddSpeaker',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );

appdata = [];
appdata.lastValidTag = 'GoPrediction';
...
'BackgroundColor',get(0,'defaultuicontrolBackgroundColor'),...
'Callback',mat{2},...
'Position',[42.6666666666667 1.41666666666667 11 1.75],...
'String','GO!',...
'Tag','GoPrediction',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
